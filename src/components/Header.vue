		...
		<div class="left__nav">
			...
			<div v-if="routeName.includes('Library')" class="library__tab">
				<router-link
					...
					:class="{ active: routeName === 'LibraryPlaylists' }"
					>Playlists</router-link
				>
				<router-link
					to="/library/podcasts"
					:class="{ active: routeName === 'LibraryPodcasts' }"
					>Podcasts</router-link
				>
				<router-link
					to="/library/artists"
					:class="{ active: routeName === 'LibraryArtists' }"
					>Artists</router-link
				>
				<router-link
					to="/library/albums"
					:class="{ active: routeName === 'LibraryAlbums' }"
					>Albums</router-link
				>
			</div>
		</div>
